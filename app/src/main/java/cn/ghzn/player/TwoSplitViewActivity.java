    ...
    private void initWidget(String split_mode) {
        switch (split_mode){
            case "1":
                ...
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two1_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two1_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two1_2);
                break;
            case "2":
                imageView_1 = (ImageView)this.findViewById(R.id.imageView_two2_1);
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two2_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two2_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two2_2);
                break;
            case "3":
                imageView_1 = (ImageView)this.findViewById(R.id.imageView_two3_1);
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two3_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two3_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two3_2);
                break;
            case "4":
                imageView_1 = (ImageView)this.findViewById(R.id.imageView_two4_1);
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two4_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two4_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two4_2);
                break;
            case "5":
                imageView_1 = (ImageView)this.findViewById(R.id.imageView_two5_1);
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two5_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two5_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two5_2);
                break;
            case "6":
                imageView_1 = (ImageView)this.findViewById(R.id.imageView_two6_1);
                videoView_1 = (VideoView)this.findViewById(R.id.videoView_two6_1);
                imageView_2 = (ImageView)this.findViewById(R.id.imageView_two6_2);
                videoView_2 = (VideoView)this.findViewById(R.id.videoView_two6_2);
                break;
            default:
                Log.d(TAG,"default");
                break;
